...
namespace Dms_Testing
{
    ...
    public class tstHolidaysCollection
    {
        ...
        public void HolidaysListOK()
        {
            ...
            TestItem.EndDate = Convert.ToDateTime("2022, 03, 20"); //set according to laptob format otherwise causing errors
        ...
        public void ThisHolidayOK()
        {
            ...
            TestHolidays.EndDate = Convert.ToDateTime("2022, 03, 20"); //set according to laptob format otherwise causing errors
            //assign the data to the property
        ...
        public void AddMethodOK()
        {
            ...
            TestItem.StartDate = Convert.ToDateTime("2022, 03, 19"); //set the date according to laptob format i.e day/month/year otherwise causing errors
            TestItem.EndDate = Convert.ToDateTime("2022, 03, 20"); //set according to laptob format otherwise causing errors
        ...
        public void DeleteMethodOK()
        {
            ...
            TestItem.EmpDepart = "test";
            TestItem.Reason = "test";
            TestItem.StartDate = Convert.ToDateTime("2022, 03, 19"); //set according to laptob format otherwise causing errors
            TestItem.EndDate = Convert.ToDateTime("2022, 03, 20"); //set according to laptob format otherwise causing errors
            //set this addres to the test data
            AllHolidays.ThisHolidays = TestItem;
            //add the record
        ...
        public void UpdateMethodOK()
        {
            ...
            TestItem.StartDate = Convert.ToDateTime("2022, 03, 17"); //set according to laptob format otherwise causing errors
            TestItem.EndDate = Convert.ToDateTime("2022, 03, 19"); //set according to laptob format otherwise causing errors
